    ...
    template: `
      <div class="max-w-full overflow-x-auto mb-1">
       <div class="flex flex-wrap justify-center">
         ...
         <!-- Barium -->
         <div class="element bg-gradient-to-r from-red-500 to-amber-600 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-amber-600 border-2">
         ...
         <!-- Hafnium -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 ml-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">72</div>
           <div class="symbol text-sm">Hf</div>
           <div class="element-name text-xs">Hafnium</div>
           <div class="atomic-weight text-xs">178.49</div>
         </div>
         <!-- Tantalum -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">73</div>
         ...
         <!-- Tungsten -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">74</div>
         ...
         <!-- Rhenium -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">75</div>
         ...
         <!-- Osmium -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">76</div>
         ...
         <!-- Iridium -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">77</div>
         ...
         <!-- Platinum -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">78</div>
         ...
         <!-- Gold -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">79</div>
         ...
         <!-- Mercury -->
         <div class="element bg-gradient-to-r from-sky-400 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">80</div>
           <div class="symbol text-sm">Hg</div>
           <div class="element-name text-xs">Mercury</div>
           <div class="atomic-weight text-xs">200.59</div>
         </div>
         <!-- Thallium -->
         <div class="element bg-gradient-to-r from-violet-500 to-fuchsia-400 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-violet-400 border-2">
           <div class="atomic-number text-xs">81</div>
         ...
         <!-- Lead -->
         <div class="element bg-gradient-to-r from-violet-500 to-fuchsia-400 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-violet-400 border-2">
           <div class="atomic-number text-xs">82</div>
         ...
         <!-- Bismuth -->
         <div class="element bg-gradient-to-r from-violet-500 to-fuchsia-400 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-violet-400 border-2">
           <div class="atomic-number text-xs">83</div>
         ...
         <div class="element bg-gradient-to-r from-fuchsia-500 to-violet-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-violet-700 border-2">
           <div class="atomic-number text-xs">84</div>
         ...
         <div class="element bg-gradient-to-r from-violet-500 to-blue-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-blue-700 border-2">
           <div class="atomic-number text-xs">85</div>
         ...
         <div class="element bg-gradient-to-r from-lime-500 to-green-700 p-1 text-center text-white font-mont hover:border-green-400 border-green-700 border-2">
           <div class="atomic-number text-xs">86</div>

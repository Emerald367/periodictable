    ...
    template: `
       <div class="max-w-full overflow-x-auto mt-3 mb-1">
        <div class="flex flex-wrap justify-center">
          ...
          <div class="empty-space"></div>
          <!-- Lanthanum -->
          <div class="element bg-gradient-to-r from-cyan-300 to-cyan-700 p-1 text-center text-white font-mont mr-1 ml-2">
          ...
          <!-- Cerium -->
          <div class="element bg-gradient-to-r from-cyan-300 to-cyan-700 p-1 text-center text-white font-mont mr-1">
          ...
          <!-- Lutetium -->
          <div class="element bg-gradient-to-r from-cyan-300 to-cyan-700 p-1 text-center text-white font-mont">

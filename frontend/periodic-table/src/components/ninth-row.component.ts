   ...
   template: `
      <div class="max-w-full overflow-x-auto mb-5">
       <div class="flex flex-wrap justify-center">
         ...
         <div class="empty-space"></div>
         <!-- Actinium -->
         <div class="element bg-gradient-to-r from-green-400 to-cyan-700 p-1 text-center text-white font-mont mr-1 ml-2 hover:border-green-400 border-cyan-700 border-2">
         ...
         <!-- Thorium -->
         <div class="element bg-gradient-to-r from-green-400 to-cyan-700 p-1 text-center text-white font-mont mr-1 hover:border-green-400 border-cyan-700 border-2">
         ...
         <!-- Lawrencium -->
         <div class="element bg-gradient-to-r from-green-400 to-cyan-700 p-1 text-center text-white font-mont hover:border-green-400 border-cyan-700 border-2">

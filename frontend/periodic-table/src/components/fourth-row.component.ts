    ...
    template: `
     <div class="max-w-full overflow-x-auto mb-1">
      <div class="flex flex-wrap justify-center">
       <!-- Potassium -->
       <div class="element bg-gradient-to-r from-pink-500 to-red-600 text-center text-white font-mont p-1 mr-1">
       ...
       <!-- Calcium -->
       <div class="element bg-gradient-to-r from-red-500 to-amber-600 text-center text-white font-mont p-1 mr-1">
       ...
       <!-- Scandium -->
       <div class="element bg-gradient-to-r from-sky-400 to-blue-700 text-center text-white font-mont p-1 mr-1">
       ...
       <!-- Gallium -->
       <div class="element bg-gradient-to-r from-violet-500 to-fuchsia-400 text-center text-white font-mont p-1 mr-1">
       ...
       <!-- Germanium --> 
       <div class="element bg-gradient-to-r from-fuchsia-500 to-violet-700 text-center text-white font-mont p-1 mr-1">
       ...
       <!-- Selenium -->
       <div class="element bg-gradient-to-r from-violet-500 to-blue-700 text-center text-white font-mont p-1 mr-1">
       ...
       <!-- Krypton -->
       <div class="element bg-gradient-to-r from-lime-500 to-green-700 text-center text-white font-mont p-1">
